      ...
      <SourceCard>
        ...
        <DocumentBody>
          ...
          <DocumentText>
            [...] {beforeFirst}
            {firstHighlight ? (
              <PrimaryHighlight>{firstHighlight}</PrimaryHighlight>
            ) : null}
            {betweenHighlights}
            {secondHighlight ? (
              <SecondaryHighlight>{secondHighlight}</SecondaryHighlight>
            ) : null}
            {afterSecond} [...]
          </DocumentText>
          ...
          <Footer>
            <FooterLine>
              FUENTE PUBLICA: LEY 27.275 DE ACCESO A LA INFORMACION
            </FooterLine>
